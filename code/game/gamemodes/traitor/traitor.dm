...
/datum/game_mode/traitor
	...
	protected_jobs = list("Security Officer", "Warden", "Internal Affairs Agent", "Head of Security", "Captain", "Blueshield Guard")//AI", Currently out of the list as malf does not work for shit
	required_players = 0
	required_enemies = 1
